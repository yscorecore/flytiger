...
namespace FlyTiger.IntegrationTest.Mapper
{
    ...
    public class ConvertEnumerableTest
    {
        ...
        public void ShouldConvertArrayToImmutableArray()
        {
            ...
            AsEnumerable(user).To<TargetUser_ArrayToImmutableArray>().First().Should().BeEquivalentTo(new TargetUser_ArrayToImmutableArray
            {
                Name = "zhangsan",
        ...
        public void ShouldConvertArrayToImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_ArrayToImmutableList>().First().Should().BeEquivalentTo(new TargetUser_ArrayToImmutableList
            {
                Name = "zhangsan",
        ...
        public void ShouldConvertArrayToIImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_ArrayToIImmutableList>().First().Should().BeEquivalentTo(new TargetUser_ArrayToIImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertListToImmutableArray()
        {
            ...
            AsEnumerable(user).To<TargetUser_ListToImmutableArray>().First().Should().BeEquivalentTo(new TargetUser_ListToImmutableArray
            {
                Name = "zhangsan",
                Addresses = ImmutableArray.Create(
        ...
        public void ShouldConvertListToImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_ListToImmutableList>().First().Should().BeEquivalentTo(new TargetUser_ListToImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertListToIImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_ListToIImmutableList>().First().Should().BeEquivalentTo(new TargetUser_ListToIImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertIListToImmutableArray()
        {
            ...
            AsEnumerable(user).To<TargetUser_IListToImmutableArray>().First().Should().BeEquivalentTo(new TargetUser_IListToImmutableArray
            {
                Name = "zhangsan",
                Addresses = ImmutableArray.Create(
        ...
        public void ShouldConvertIListToImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_IListToImmutableList>().First().Should().BeEquivalentTo(new TargetUser_IListToImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertIListToIImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_IListToIImmutableList>().First().Should().BeEquivalentTo(new TargetUser_IListToIImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertICollectionToImmutableArray()
        {
            ...
            AsEnumerable(user).To<TargetUser_ICollectionToImmutableArray>().First().Should().BeEquivalentTo(new TargetUser_ICollectionToImmutableArray
            {
                Name = "zhangsan",
                Addresses = ImmutableArray.Create(
        ...
        public void ShouldConvertICollectionToImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_ICollectionToImmutableList>().First().Should().BeEquivalentTo(new TargetUser_ICollectionToImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertICollectionToIImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_ICollectionToIImmutableList>().First().Should().BeEquivalentTo(new TargetUser_ICollectionToIImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertIEnumerableToImmutableArray()
        {
            ...
            AsEnumerable(user).To<TargetUser_IEnumerableToImmutableArray>().First().Should().BeEquivalentTo(new TargetUser_IEnumerableToImmutableArray
            {
                Name = "zhangsan",
                Addresses = ImmutableArray.Create(
        ...
        public void ShouldConvertIEnumerableToImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_IEnumerableToImmutableList>().First().Should().BeEquivalentTo(new TargetUser_IEnumerableToImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertIEnumerableToIImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_IEnumerableToIImmutableList>().First().Should().BeEquivalentTo(new TargetUser_IEnumerableToIImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertIQueryableToImmutableArray()
        {
            ...
            AsEnumerable(user).To<TargetUser_IQueryableToImmutableArray>().First().Should().BeEquivalentTo(new TargetUser_IQueryableToImmutableArray
            {
                Name = "zhangsan",
                Addresses = ImmutableArray.Create(
        ...
        public void ShouldConvertIQueryableToImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_IQueryableToImmutableList>().First().Should().BeEquivalentTo(new TargetUser_IQueryableToImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
        ...
        public void ShouldConvertIQueryableToIImmutableList()
        {
            ...
            AsEnumerable(user).To<TargetUser_IQueryableToIImmutableList>().First().Should().BeEquivalentTo(new TargetUser_IQueryableToIImmutableList
            {
                Name = "zhangsan",
                Addresses = ImmutableList.Create(
